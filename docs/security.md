...
- Developer ID signing, Apple Notarization, and Gatekeeper verification are planned (tracked in [#391](https://github.com/T3pp31/DockBridge/issues/391)); the scripts below are ready when repository secrets are configured
...
#### Release signing pipeline (planned; see [#391](https://github.com/T3pp31/DockBridge/issues/391))
