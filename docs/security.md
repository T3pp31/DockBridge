...
```bash
gh attestation verify DockBridge-<version>-macOS.dmg --owner T3pp31
gh attestation verify dockbridge-<version>-macOS --owner T3pp31
gh attestation verify DockBridge-<version>.cdx.json --owner T3pp31
```
